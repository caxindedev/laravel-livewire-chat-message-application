@extends('templates.secretaria')


@section('secretaria-content')
...
<div class="col-sm-12 col-lg-12">
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <div class="header-title">
                <h4 class="card-title">Editar dados aluno: {{ $aluno['nome'] }}</h4>
            </div>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('aluno.update', $aluno['id']) }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="nome" value="{{ $aluno['nome'] }}" type="text" class="form-control" id="email1">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="form-label" for="exampleFormControlSelect1">Genero</label>
                        <select name="genero" class="form-select" id="exampleFormControlSelect1">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="data_nascimento" value="{{ $aluno['data_nascimento'] }}" type="date" class="form-control" id="email1">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="form-label" for="pwd">Email:</label>
                        <input name="email" value="{{ $aluno['email'] }}" type="email" class="form-control" id="pwd">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="form-label" for="email">Telefone:</label>
                        <input name="telefone" value="{{ $aluno['telefone'] }}" type="text" class="form-control" id="email1">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="form-label" for="pwd">Genero:</label>
                        <input name="pais" type="text" class="form-control" id="pwd">
                    </div>
                </div>
                </div>
