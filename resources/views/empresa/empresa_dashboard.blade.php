        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ url('assets/images/logo.png') }}" style="width: 187px" alt=""
                            height="17">
                    </span>
                </a>
                <!-- Light Logo-->
                <a href="index.html" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ url('assets/images/logo.png') }}" style="width: 187px; height: 60px"
                            alt="" height="17">
                    </span>
                </a>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('aluno.dashboard') }}" role="button"
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('aluno.create') }}" class="nav-link"
                                            data-key="t-chat">Dados do aluno</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('aluno.historico.create') }}" class="nav-link"
                                            data-key="t-chat">Histórico de Doenças</a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse"
                                ...
                                <i class="ri-account-circle-line"></i> <span data-key="t-authentication">As Minhas
                                    medidas</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarAuth">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('aluno.medida.create') }}" class="nav-link" role="button"
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('aluno.plano') }}" role="button"
                                ...
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="layouts-horizontal.html" target="_blank" class="nav-link"
                                            data-key="t-horizontal">Calendário Individual</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="layouts-detached.html" target="_blank" class="nav-link"
                                            data-key="t-detached">Calendário em Grupo</a>
                                    </li>
                                ...
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="advance-ui-sweetalerts.html" class="nav-link"
                                            data-key="t-sweet-alerts">Primeira Fase</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="advance-ui-nestable.html" class="nav-link"
                                            data-key="t-nestable-list">Segunda Fase</a>
                                    </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarTables">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="tables-basic.html" class="nav-link" data-key="t-basic-tables">Aulas
                                            Gravadas</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="tables-gridjs.html" class="nav-link"
                                            data-key="t-grid-js">Ferramentas de Apoio</a>
                                    </li>
