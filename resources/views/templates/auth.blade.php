            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    {{-- <ul class="navbar-nav" id="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('dashboard.secretaria') }}" role="button"
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarForms">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('agendamento.create') }}" class="nav-link"
                                            data-key="t-form-select"> Agendar Atividades </a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="{{ route('agendamento.index') }}" class="nav-link"
                                            data-key="t-basic-elements">Ver Atividades</a>
                                    </li>
