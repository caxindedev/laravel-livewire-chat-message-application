            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ url('assets/images/nutricare-logo.png') }}" width="170" alt="" height="65">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ url('assets/images/nutricare-logo.png') }}" width="170" alt="" height="65">
                        </span>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('dashboard.aluno') }}"  role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                                <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Início</span>
                            </a>
                            
                        </li> <!-- end Dashboard Menu -->
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('aluno.dadosPessoais') }}" role="button" aria-expanded="false" aria-controls="sidebarForms">
                                <i class="ri-file-list-3-line"></i> <span data-key="t-forms">Dados pessoais</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="menu-dropdown collapse" id="sidebarAuth" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="#sidebarSignIn" class="nav-link collapsed" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSignIn" data-key="t-signin"> Instruções
                                        </a>                                        
                                    </li>
                                    <li class="nav-item">
                                        <a href="#sidebarSignUp" class="nav-link collapsed" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSignUp" data-key="t-signup"> Prmeira Medida
                                        </a>                                        
                                    </li>

                                    <li class="nav-item">
                                        <a href="#sidebarResetPass" class="nav-link collapsed" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarResetPass" data-key="t-password-reset"> Password Reset
                                        </a>
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarLockScreen" class="nav-link collapsed" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLockScreen" data-key="t-lock-screen"> Lock Screen
                                        </a>
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarLogout" class="nav-link collapsed" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLogout" data-key="t-logout"> Logout
                                        </a>
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarSuccessMsg" class="nav-link collapsed" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSuccessMsg" data-key="t-success-message"> Success Message
                                        </a>
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarTwoStep" class="nav-link collapsed" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarTwoStep" data-key="t-two-step-verification"> Two Step Verification
                                        </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarLayouts" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                                <i class="ri-layout-3-line"></i> <span data-key="t-layouts">O Meu Plano
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarIcons" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarIcons">
                                <i class="ri-compasses-2-line"></i> <span data-key="t-icons">Agenda</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarIcons">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('curso.create') }}" class="nav-link" data-key="t-remix">Calendário Individual</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('curso.index') }}" class="nav-link" data-key="t-boxicons">Calendário de Grupo</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                                <i class="ri-account-circle-line"></i> <span data-key="t-authentication">E-books</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarAuth">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{  route('turma.create') }}" class="nav-link"  role="button" aria-expanded="false" aria-controls="sidebarSignIn" data-key="t-signin"> Nova Turma
                                        </a>                                        
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{  route('turma.index') }}" class="nav-link" role="button" aria-expanded="false" aria-controls="sidebarSignUp" data-key="t-signup"> Lisar Turmas
                                        </a>                                        
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link collapsed" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                                <i class="ri-apps-2-line"></i> <span data-key="t-apps">Mentoria</span>
                            </a>
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="menu-dropdown collapse" id="sidebarEmail" style="">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="apps-mailbox.html" class="nav-link" data-key="t-mailbox"> E-book de Receitas </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#sidebaremailTemplates" class="nav-link collapsed" role="button" aria-expanded="false" aria-controls="sidebaremailTemplates" data-key="t-email-templates">
                                                        Suplementos
                                                    </a>
        ...
        <div class="main-content">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © Nutricare.
                        </div>
                        <div class="col-sm-6">
